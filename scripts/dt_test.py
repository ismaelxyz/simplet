...
"""
['deepl', 'google', 'libre', 'linguee', 'microsoft', 'mymemory', 'papago', 'pons', 'qcri', 'yandex']

Motivación

SimpleT es una herramienta útil para traducir, la base de dicha aplicación esta
escrita en Python y la GUI en Rust, se supone que la comunicación entre las
partes debería ser fluida, al no lograr eso... Ahora este crate disminuye los
deberes de Python.
"""

def microsoft_languages():
    ...
    print(microsoft_languages_response.json())
...
def translation_dict_example():
    translation_dict = {'translation': 
        {
         ...
         'as': {'name': 'Assamese', 'nativeName': 'অসমীযা', 'dir': 'ltr'},
         ...
         'bo': {'name': 'Tibetan', 'nativeName': 'བད་སད་', 'dir': 'ltr'}, 
         ...
         'dv': {'name': 'Divehi', 'nativeName': 'ދވހބސ', 'dir': 'rtl'}, 
         ...
         'gu': {'name': 'Gujarati', 'nativeName': 'ગજરાતી', 'dir': 'ltr'}, 
         'he': {'name': 'Hebrew', 'nativeName': 'עברית', 'dir': 'rtl'}, 
         'hi': {'name': 'Hindi', 'nativeName': 'हिनदी', 'dir': 'ltr'}, 
         ...
         'iu-Latn': {'name': 'Inuktitut (Latin)', 'nativeName': 'Inuktitut (Latin)', 'dir': 'ltr'}, 
         ...
         'km': {'name': 'Khmer', 'nativeName': 'ខមែរ', 'dir': 'ltr'}, 
         'kmr': {'name': 'Kurdish (Northern)', 'nativeName': 'Kurdî (Bakur)', 'dir': 'ltr'}, 
         'kn': {'name': 'Kannada', 'nativeName': 'ಕನನಡ', 'dir': 'ltr'}, 
         ...
         'my': {'name': 'Myanmar (Burmese)', 'nativeName': 'မြနမာ', 'dir': 'ltr'}, 
         'nb': {'name': 'Norwegian', 'nativeName': 'Norsk Bokmål', 'dir': 'ltr'}, 
         'ne': {'name': 'Nepali', 'nativeName': 'नपाली', 'dir': 'ltr'}, 
         'nl': {'name': 'Dutch', 'nativeName': 'Nederlands', 'dir': 'ltr'}, 
         'or': {'name': 'Odia', 'nativeName': 'ଓଡଆ', 'dir': 'ltr'}, 
         'otq': {'name': 'Querétaro Otomi', 'nativeName': 'Hñähñu', 'dir': 'ltr'}, 
         'pa': {'name': 'Punjabi', 'nativeName': 'ਪਜਾਬੀ', 'dir': 'ltr'}, 
         ...
         'ta': {'name': 'Tamil', 'nativeName': 'தமிழ', 'dir': 'ltr'}, 
         'te': {'name': 'Telugu', 'nativeName': 'తలుగు', 'dir': 'ltr'}, 
    ...
    res = {
        translation_dict[k]["name"]: k
        for k in translation_dict.keys()
    }
    for key, value in res.items():
        print(f"\"{key}\" => \"{value}\",")

translation_dict_example()